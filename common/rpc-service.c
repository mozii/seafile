...
GList *
seafile_get_repo_token_list (const char *repo_id,
                             GError **error)
{
    GList *ret_list;
    ...
    ret_list = seaf_repo_manager_get_repo_token_list (seaf->repo_mgr, repo_id, error);

    return ret_list;
}

GList *
seafile_get_repo_token_list_by_email (const char *repo_id,
                                      const char *email,
                                      GError **error)
{
    GList *ret_list;
    ...
    ret_list = seaf_repo_manager_get_repo_token_list_by_email (seaf->repo_mgr, repo_id, email, error);    
